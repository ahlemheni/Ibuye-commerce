...
--}}
    ...
    <nav class="navbar fixed-top navbar-expand-lg scrolling-navbar double-nav">
      ...
      <div class="float-left">
        <a href="#" data-activates="slide-out" class="button-collapse black0-text"><strong style="font-size: 30px;color:blue">I</strong><span style="color: #5D6865">buy</span></a>
        </div>
      <!-- Breadcrumb-->
            ...
            <div class="row">
              ...
              <div class="col-xl-4 col-md-6 mb-xl-0 mb-4">
                ...
                <div class="card card-cascade cascading-admin-card">
                  ...
                  <!-- Card Data -->
                  <div class="admin-up">
                  <i class="fas fa-layer-group primary-color mr-3 z-depth-2" ></i>
              ...
              <div class="col-xl-4 col-md-6 mb-xl-0 mb-4">
                ...
                <div class="card card-cascade cascading-admin-card">
                  ...
                  <!-- Card Data -->
                  <div class="admin-up">
                  <i class="fas fa-shopping-basket warning-color mr-3 z-depth-2"></i>
