...
<form action="{{route('searchproduit')}}" method="post">
      ...
      <div class="row">
        ...
        <div class="col-md-2">
        <button class="btn btn-primary form-control text-center" style=" margin-top: 3px; padding:8px;">Serach</button>
        </div>
      ...
      <div class="table-responsive">
        ...
        <table class="table table-hover mb-0">
          ...
          <tbody>
            ...
            <tr>
            <td>{{$produit->id}}</td>
            <td><img src="{{$produit->photo}}" style="width: 30px; ">&nbsp; &nbsp;{{$produit->name}}</td>
...
<!-----------------------------end Modal update Product----------------------->
   ...
   <form action="{{route('addproduit')}}" method="POST" enctype="multipart/form-data">
       ...
       <div class="row">
        <div class="col-md-4">
          <div class="md-form form-sm">    
            <input type="number" id="form19" name="prix" class="form-control form-control-sm" required>
            <label for="form19">Prix </label>
         </div>
        </div>
        <div class="col-md-4">
          <div class="md-form form-sm">    
            <input type="number" id="form19" name="offre" class="form-control form-control-sm" required>
            <label for="form19">Offre </label>
         </div>
        </div>
        <div class="col-md-4">
          <div class="md-form form-sm">    
            <input type="number" id="form19" name="qte" class="form-control form-control-sm" required>
            <label for="form19">Qte </label>
         </div>
        </div>
       </div>
