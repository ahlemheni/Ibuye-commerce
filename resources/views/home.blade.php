...
<form action="{{route('searchuser')}}" method="post">
      ...
      <div class="row">
        ...
        <div class="col-md-7">
          <input class="form-control" type="text" name="text" placeholder="nom,prenom,email,adresse,role,telephone.." aria-label="Search">

        </div>
        <div class="col-md-2"><button class="btn btn-primary form-control text-center" style=" margin-top: 3px; padding:8px;">Serach</button></div>
